...
LOG_FILE="access.log"
NUM_ENTRIES=10000  # عدد السجلات المطلوبة

# إفراغ الملف إذا كان موجودًا
> $LOG_FILE
...
for ((i=0; i<NUM_ENTRIES; i++)); do
    ...
    HOUR=$(printf "%02d" $((RANDOM % 24)))  # ساعة من 00 إلى 23
    MIN=$(printf "%02d" $((RANDOM % 60)))   # دقيقة من 00 إلى 59
    SEC=$(printf "%02d" $((RANDOM % 60)))   # ثانية من 00 إلى 59
    SIZE=$((RANDOM % 10000 + 500))          # حجم الاستجابة بين 500 و10500 بايت
